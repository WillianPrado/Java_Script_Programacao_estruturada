...
//06) Crie um método que compara dois conjuntos. Retorna true se forem iguais (tiverem exatamente os mesmos elementos), retorna false se forem diferentes.
...
console.log("O Conjunto0 e conjunto1 são iguais?");
contem(conjunto, conjunto1);

console.log("O Conjunto0 e conjunto2 são iguais?");
contem(conjunto, conjunto2);